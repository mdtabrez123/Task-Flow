...
const LOCKED_SIGNUP_LAYOUT = Object.freeze({
  shell:
    'relative w-full max-w-[340px] pt-[100px] sm:max-w-[380px] sm:pt-[112px] md:max-w-[420px] md:pt-[120px] lg:max-w-[440px]',
  image:
    'pointer-events-none absolute left-[-80px] top-[40px] z-20 w-[330px] drop-shadow-[8px_16px_16px_rgba(0,0,0,0.5)] drop-shadow-[0_30px_40px_rgba(0,0,0,0.25)] sm:left-[-100px] sm:top-[50px] sm:w-[370px] md:left-[-130px] md:top-[60px] md:w-[430px] lg:left-[-140px] lg:top-[80px] lg:w-[460px]',
  card:
  ...
  return (
    <div className="min-h-screen bg-[#f3efe8] px-4 py-8 sm:px-6 lg:px-8 flex items-center justify-center overflow-hidden">
      <div className="mx-auto flex w-full max-w-5xl items-center justify-center">
        <div className={LOCKED_SIGNUP_LAYOUT.shell}>
          <section className={LOCKED_SIGNUP_LAYOUT.card}>
            <p className="uppercase tracking-[0.15em] text-[10px] sm:text-xs font-bold text-slate-500">New Workspace</p>
            <h1 className="mt-2 font-serif text-4xl sm:text-[44px] tracking-tight text-slate-900">Create account</h1>
            <p className="mt-3 text-sm leading-relaxed text-slate-600">
              Start your planning system with a calm, design-forward workflow.
            </p>

            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              <div>
                <label htmlFor="name" className="uppercase tracking-[0.1em] text-[10px] font-bold text-slate-500 block pb-2">
                  Name
                </label>
                <Input
                  id="name"
              ...
              <Button type="submit" className="mt-6 h-12 w-full rounded-2xl bg-[#EB5E28] hover:bg-[#d95321] text-white shadow-[0_8px_20px_rgba(235,94,40,0.25)] transition-all flex items-center justify-center font-medium text-base">
